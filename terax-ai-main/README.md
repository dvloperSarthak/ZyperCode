<div align="center">
  ...
  <p>
    <a href="https://zypercode.com">Website</a>
    ·
...
- **Agentic workflow:** plans, sub-agents, project memory via `ZYPERCODE.md`, file read / write / edit / multi-edit / grep / glob, bash with approval gating, background processes
...
1. Open **Settings -> AI**.
2. Pick a provider and paste your API key. For local inference, point ZyperCode at your LM Studio / MLX / Ollama endpoint.
...
ZyperCode is licensed under the Apache-2.0 License. For more information on our dependencies, see [Apache License 2.0](LICENSE).
