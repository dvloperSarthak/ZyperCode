...
ZyperCode direction, what's shipped, what's coming, and what's deliberately out of scope.
...
- Not an IDE clone. ZyperCode selectively integrates high-value editor capabilities such as LSP, AI autocomplete, formatting, source control, and previews without adopting the heavyweight runtime and always-on background services of a traditional IDE.
