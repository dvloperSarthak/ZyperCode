...
Die neuesten Installationspakete stehen auf der Seite [Releases](https://github.com/crynta/terax-ai/releases/latest). ZyperCode aktualisiert sich von dort automatisch.
...
2. Wähle einen Anbieter und füge deinen API-Schlüssel ein. Für lokale Inferenz verweist du ZyperCode auf deinen LM Studio- / MLX- / Ollama-Endpunkt.
...
ZyperCode steht unter der Apache-2.0-Lizenz. Weitere Informationen zu unseren Abhängigkeiten findest du in der [Apache License 2.0](../../LICENSE).
