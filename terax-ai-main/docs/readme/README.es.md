...
Los instaladores más recientes están en la página de [Releases](https://github.com/crynta/terax-ai/releases/latest). ZyperCode se actualiza automáticamente desde allí.
...
1. Abre **Ajustes -> IA**.
2. Elige un proveedor y pega tu clave API. Para inferencia local, apunta ZyperCode a tu endpoint de LM Studio / MLX / Ollama.
...
ZyperCode se distribuye bajo la licencia Apache-2.0. Para más información sobre las dependencias, consulta [Apache License 2.0](../../LICENSE).
