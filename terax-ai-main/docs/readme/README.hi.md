...
नवीनतम इंस्टॉलर [Releases](https://github.com/crynta/terax-ai/releases/latest) पेज पर हैं। ZyperCode वहीं से अपने आप अपडेट होता है।
...
1. **सेटिंग्स -> AI** खोलें।
2. प्रदाता चुनें और API कुंजी पेस्ट करें। स्थानीय इन्फ़रेंस के लिए ZyperCode को LM Studio / MLX / Ollama endpoint पर निर्देशित करें।
...
ZyperCode Apache-2.0 लाइसेंस के अंतर्गत है। निर्भरताओं की जानकारी के लिए [Apache License 2.0](../../LICENSE) देखें।
