<div align="center">
  <img src="../../public/logo.png" width="144" height="144" alt="ZyperCode" />
  <h1>ZyperCode</h1>
...
Penginstal terbaru tersedia di halaman [Releases](https://github.com/crynta/terax-ai/releases/latest). ZyperCode melakukan pembaruan otomatis dari sana.
...
2. Pilih penyedia dan tempel kunci API. Untuk inferensi lokal, arahkan ZyperCode ke endpoint LM Studio / MLX / Ollama.
...
ZyperCode dilisensikan di bawah Apache-2.0. Untuk informasi tentang dependensi, lihat [Apache License 2.0](../../LICENSE).
