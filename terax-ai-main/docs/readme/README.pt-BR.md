...
Os instaladores mais recentes estão na página de [Releases](https://github.com/crynta/terax-ai/releases/latest). O ZyperCode se atualiza automaticamente por ela.
...
O ZyperCode é licenciado sob a Apache-2.0. Para informações sobre dependências, consulte a [Apache License 2.0](../../LICENSE).
