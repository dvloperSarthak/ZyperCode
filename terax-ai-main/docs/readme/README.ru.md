...
Последние установщики находятся на странице [Releases](https://github.com/crynta/terax-ai/releases/latest). ZyperCode автоматически обновляется оттуда.
...
ZyperCode распространяется по лицензии Apache-2.0. Информацию о зависимостях см. в [Apache License 2.0](../../LICENSE).
